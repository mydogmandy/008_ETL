...
file_dir = '/Users/mikebenzy/Bootcamp_Class/etl3'

# Load movie and ratings raw data:
...
def clean_movie(movie):
    ...
    for key in ['Also known as','Arabic','Cantonese',
                ...
                'Hepburn','Japanese','Literally',
                'Mandarin','McCune-Reischauer',
...
# Prepare SQL tables for data export:
from sqlalchemy import create_engine
from config import db_password
db_string = f'postgres://postgres:{db_password}@127.0.0.1:5432/movie_data'
engine = create_engine(db_string)

# Remove existing data from the movies table, leaving the structure intact:
engine.execute("TRUNCATE TABLE movies")

# Load data into the movies table:
movies_df.to_sql(name='movies', con=engine, if_exists='append')

# Remove existing data from the ratings table, leaving the structure intact:
